...
const translation: LangKeys = {
    ...
    fleet: 'Flota',
    clients: 'Clientes',
    visit_plannig: 'Plan de Visitas',
    visits: 'Visitas',
    visitDate: 'Dia de Visita',
    visitStart: 'Inicio de Visita',
    hourstart: 'Hora comienzo',
    selfiehour: 'Hora Selfie',
    attendance_report: 'Reporte de Asistencia',
    hourend: 'Hora final',
    finishdatevisit: 'Hora Finalizada',
    assistancereport: 'Reporte de Asistencia',
    zone: 'Zona',
    kpis: 'KPIS',
    ...
    role: 'Rol',
    editrole: 'Editar Rol',
    setrolepermissions: 'Establecer los permisos de los roles',
    role_permission: 'Permisos del Rol',
    favorite: "Favorito",
    role_plural: 'Roles',
    ...
    reassign_visit: 'Reasignar visita',
    successful_reasign_visit: 'Las visitas se reasignaron satisfactoriamente',
    confirmation_reasign_visit: 'Estas seguro de reasignar las visitas?',
    typify: 'Tipificar',
    ...
    merchant_user: 'Mercaderista Asignado',
    merchandise: 'Mercancia',
    merchandises: 'Mercancias',
    newmerchandise: 'Nuevo Mercancia',
    product: 'Producto',
    products: 'Productos',
    ...
    brand: 'Marca',
    minimum_quantity: 'Cantidad minima',
    impeller_user: 'Impulsador Asignado',
    rate: "Tasa",
    basecost: "Costo base",
    ...
    inventory_relief: 'Relevo de inventario',
    closed2: 'Cerrado',
    done: 'Hecho',
