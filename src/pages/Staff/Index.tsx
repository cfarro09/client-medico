...
const Staff: FC = () => {
    ...
    useEffect(() => {
        if (applications) {
            setPagePermissions({
                view: applications["/staff"][0],
                modify: applications["/staff"][1],
                insert: applications["/staff"][2],
                delete: applications["/staff"][3],
                download: applications["/staff"][4],
            });
        }
    }, [applications]);
    ...
    // MainDataFill
    useEffect(() => {
        if (!mainResult.loading && !mainResult.error && mainResult.key === "UFN_STAFF_SEL") {
