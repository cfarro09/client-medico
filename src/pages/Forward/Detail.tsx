...
import { Button, makeStyles, IconButton, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TableFooter, AppBar, Tab, Box } from '@material-ui/core';
...
const DetailPurcharse: React.FC<DetailModule> = ({ row, setViewSelected, fetchData }) => {
    ...
    React.useEffect(() => {
        ...
        register("vehicleid", { validate: (value) => (value && value > 0) || "" + t(langKeys.field_required) });
    ...
    return (
        <div style={{ width: "100%" }}>
            <form onSubmit={onSubmit}>
                ...
                {!!row && <>
                        ...
                        <div className={classes.containerDetail}>
                            <div className="row-zyx">
                                <FieldSelect
                                    ...
                                    label={"Unidad"}
                                    className="col-6"
                                    valueDefault={getValues('vehicleid')}
                    ...
                    <TabPanel value="1" index={tabIndex}>
                        <div className={classes.containerDetail}>
                            ...
                            <div style={{fontSize: "1.5em", fontWeight: "bold", textAlign: "end"}}>Total: S/ 20.430,50</div>
                            <div className={classes.title} style={{padding: "10px 0"}}>
                                {"Información de Caja"}
                            </div>
                            <div style={{padding: "15px 20%"}}>
                ...
                {!row && <div className={classes.containerDetail}>
                    <div className={classes.containerDetail}>
                        <div className="row-zyx">
                            <FieldSelect
                                loading={multiData.loading}
                                ...
                                className="col-6"
                                valueDefault={getValues('vehicleid')}
                                onChange={(value) => setValue('vehicleid', value?.vehicleid || 0)}
