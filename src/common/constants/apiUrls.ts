...
const APIS_URL = {
    ...
    PRODUCTION: {
        API: 'http://38.242.249.178:6066/api',
...
const BASE_URL = (APIS_URL as Dictionary)[ENV].API
const WS_URL = (APIS_URL as Dictionary)[ENV].WS
const CHATFLOW_URL = (APIS_URL as Dictionary)[ENV].CHATFLOW
const FACEBOOKAPP = (APIS_URL as Dictionary)[ENV].FACEBOOKAPP
const INSTAGRAMAPP = (APIS_URL as Dictionary)[ENV].INSTAGRAMAPP
const CULQIKEY = (APIS_URL as Dictionary)[ENV].CULQIKEY
